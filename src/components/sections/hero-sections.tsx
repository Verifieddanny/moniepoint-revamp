...
import HeroBackground from "../illustrations/hero-background";
    ...
    return (
        <>
            ...
            <main className="flex md:min-h-screen flex-col relative pt-12 md:pt-[3rem] w-full">
               ...
               <HeroBackground className="absolute left-1/2 -translate-x-1/2 md:bottom-[28vh] -bottom-[4%] md:w-[200vw] md:h-[200vw] w-[250vw] h-[250vw] z-0" />
                ...
                <section className="w-full max-w-[90%] md:max-w-[1300px] mx-auto flex flex-col items-center text-center relative">
                    ...
                    <p 
                        data-cursor-hover
                        className="text-white font-bold md:tracking-[-0.5rem] tracking-tight leading-[106%] text-[2.5rem] md:text-6xl lg:text-[8.3125rem] md:mb-10 mb-[4.31rem] transition-all duration-300 ease-in-out relative z-50 drop-shadow-xl"
                    >
                        Simple solutions
                        <br /> to power your
                        <br /> business
